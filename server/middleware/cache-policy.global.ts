...
export default defineEventHandler((event) => {
  ...
  const cacheRules: CacheRule[] = [
    { pattern: /^\/api\/dashboard(?:\/|$|\?)/, maxAge: dashboardMaxAge, staleWhileRevalidate: dashboardSwr },
    { pattern: /^\/api\/admin\/dashboard(?:\/|$|\?)/, maxAge: adminDashboardMaxAge, staleWhileRevalidate: adminDashboardSwr },
    { pattern: /^\/api\/admin\/wings\/nodes\/[^/]+(?:\/|$|\?)/, maxAge: adminNodeMaxAge, staleWhileRevalidate: adminNodeSwr },
  ]
